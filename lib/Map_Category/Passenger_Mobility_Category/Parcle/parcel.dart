...
class ParcelModeScreen extends StatefulWidget {
  const ParcelModeScreen({Key? key}) : super(key: key);

  @override
  State<ParcelModeScreen> createState() => _ParcelModeScreenState();
}

class _ParcelModeScreenState extends State<ParcelModeScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Parcel Company Details"),
        centerTitle: true,
      ),
      body: Padding(
