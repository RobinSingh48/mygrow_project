...
class AadhaarCardScreenRickShaw extends StatefulWidget {
  const AadhaarCardScreenRickShaw({Key? key}) : super(key: key);

  @override
  State<AadhaarCardScreenRickShaw> createState() => _AadhaarCardScreenRickShaw();
}

class _AadhaarCardScreenRickShaw extends State<AadhaarCardScreenRickShaw> {
  @override
