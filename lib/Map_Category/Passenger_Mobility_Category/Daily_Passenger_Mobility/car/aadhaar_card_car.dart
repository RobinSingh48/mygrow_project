...
class AadhaarCardScreenCar extends StatefulWidget {
  const AadhaarCardScreenCar({Key? key}) : super(key: key);

  @override
  State<AadhaarCardScreenCar> createState() => _AadhaarCardScreenStateCar();
}

class _AadhaarCardScreenStateCar extends State<AadhaarCardScreenCar> {
  @override
