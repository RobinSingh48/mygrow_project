...
class CarNumberPlateScreen extends StatefulWidget {
  const CarNumberPlateScreen({Key? key}) : super(key: key);

  @override
  State<CarNumberPlateScreen> createState() => _CarNumberPlateScreenState();
}

class _CarNumberPlateScreenState extends State<CarNumberPlateScreen> {
  @override
              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Text("Car Number Plate",style: TextStyle(fontWeight: FontWeight.bold,fontSize: AppFontSize.s22),),
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Padding(
