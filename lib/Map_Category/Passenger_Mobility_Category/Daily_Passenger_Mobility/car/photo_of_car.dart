...
class PhotoOfCar extends StatefulWidget {
  const PhotoOfCar({Key? key}) : super(key: key);

  @override
  State<PhotoOfCar> createState() => _PhotoOfCar();
}

class _PhotoOfCar extends State<PhotoOfCar> {
  @override
              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Text("Car Photo",style: TextStyle(fontWeight: FontWeight.bold,fontSize: AppFontSize.s22),),
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Padding(
