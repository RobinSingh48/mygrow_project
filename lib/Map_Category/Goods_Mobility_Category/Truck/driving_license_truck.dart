...
class DrivingLicenseTruck extends StatefulWidget {
  const DrivingLicenseTruck({Key? key}) : super(key: key);

  @override
  State<DrivingLicenseTruck> createState() => _DrivingLicenseTruck();
}

class _DrivingLicenseTruck extends State<DrivingLicenseTruck> {
  @override
