...
class RcTruckScreen extends StatefulWidget {
  const RcTruckScreen({Key? key}) : super(key: key);

  @override
  State<RcTruckScreen> createState() => _RcTruckScreen();
}

class _RcTruckScreen extends State<RcTruckScreen> {
  @override
