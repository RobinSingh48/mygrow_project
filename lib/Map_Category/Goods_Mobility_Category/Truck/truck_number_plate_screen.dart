...
class TruckNumberPlateScreen extends StatefulWidget {
  const TruckNumberPlateScreen({Key? key}) : super(key: key);

  @override
  State<TruckNumberPlateScreen> createState() => _TruckNumberPlateScreen();
}

class _TruckNumberPlateScreen extends State<TruckNumberPlateScreen> {
  @override
              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Text("Truck Number Plate",style: TextStyle(fontWeight: FontWeight.bold,fontSize: AppFontSize.s22),),
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Padding(
