...
class AadhaarCardScreenTruck extends StatefulWidget {
  const AadhaarCardScreenTruck({Key? key}) : super(key: key);

  @override
  State<AadhaarCardScreenTruck> createState() => _AadhaarCardScreenTruck();
}

class _AadhaarCardScreenTruck extends State<AadhaarCardScreenTruck> {
  @override
