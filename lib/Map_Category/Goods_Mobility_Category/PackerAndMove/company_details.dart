...
class CompanyDetailsPackerAndMoveScreen extends StatefulWidget {
  const CompanyDetailsPackerAndMoveScreen({Key? key}) : super(key: key);

  @override
  State<CompanyDetailsPackerAndMoveScreen> createState() => _CompanyDetailsPackerAndMoveScreenState();
}

class _CompanyDetailsPackerAndMoveScreenState extends State<CompanyDetailsPackerAndMoveScreen> {
  @override
