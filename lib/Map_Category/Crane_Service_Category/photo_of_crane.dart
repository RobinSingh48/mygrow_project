...
class PhotoOfCrane extends StatefulWidget {
  const PhotoOfCrane({Key? key}) : super(key: key);

  @override
  State<PhotoOfCrane> createState() => _PhotoOfCrane();
}

class _PhotoOfCrane extends State<PhotoOfCrane> {
  @override
              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Text("Crane Photo",style: TextStyle(fontWeight: FontWeight.bold,fontSize: AppFontSize.s22),),
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Padding(
                        ...
                        Container(
                          ...
                          child: Center(child: Text("Crane Photo",style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold,fontSize: AppFontSize.s20),)),
                        )
                      ],
                    )
                ),
