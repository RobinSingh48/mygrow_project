...
class RcCraneScreen extends StatefulWidget {
  const RcCraneScreen({Key? key}) : super(key: key);

  @override
  State<RcCraneScreen> createState() => _RcCraneScreen();
}

class _RcCraneScreen extends State<RcCraneScreen> {
  @override
              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Text("Registration Certificate(RC) ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: AppFontSize.s22),),
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Padding(
