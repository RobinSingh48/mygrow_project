...
class CraneNumberPlateScreen extends StatefulWidget {
  const CraneNumberPlateScreen({Key? key}) : super(key: key);

  @override
  State<CraneNumberPlateScreen> createState() => _CraneNumberPlateScreen();
}

class _CraneNumberPlateScreen extends State<CraneNumberPlateScreen> {
  @override
              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Text("Crane Number Plate",style: TextStyle(fontWeight: FontWeight.bold,fontSize: AppFontSize.s22),),
                        SizedBox(height: Utils.getHeight(context)/40,),
                        Padding(
