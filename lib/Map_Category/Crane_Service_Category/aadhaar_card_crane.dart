...
class AadhaarCardScreenCrane extends StatefulWidget {
  const AadhaarCardScreenCrane({Key? key}) : super(key: key);

  @override
  State<AadhaarCardScreenCrane> createState() => _AadhaarCardScreenCrane();
}

class _AadhaarCardScreenCrane extends State<AadhaarCardScreenCrane> {
  @override
